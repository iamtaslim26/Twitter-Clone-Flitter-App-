...
class _ViewUserState extends State<ViewUser> {
  ...
  getStream()async{
    ...
    setState(() {
     ...
     userstream =
          tweetCollection.where('uid', isEqualTo: widget.uid.trim()).snapshots();
    });
  }
  ...
  getCurrentUserInfo()async{
    ...
    var firebaseuser=FirebaseAuth.instance.currentUser;
    DocumentSnapshot userdoc=await usercollection.doc(widget.uid.trim()).get();
    dataisThere=true;

      var followersdocuments=await usercollection.doc(widget.uid)
                          .collection("Followers")
                          .get();

    var followingdocuments=await usercollection.doc(onlineuseruid)
                          .collection("Followers")
                          .get();  
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: [
                                    ...
                                    child: tweetdoc['likes'].contains(onlineuseruid)?
